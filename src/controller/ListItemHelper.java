...
public class ListItemHelper {
	...
	public List<ListItem> showAllItems() {
		EntityManager em = emfactory.createEntityManager();
		List<ListItem> allItems = em.createQuery("SELECT i FROM ListItem i", ListItem.class).getResultList();
		return allItems;
	...
	public List<ListItem> searchForItemByAuthor(String authorName) {
		EntityManager em = emfactory.createEntityManager();
		em.getTransaction().begin();
		TypedQuery<ListItem> typedQuery = em.createQuery("select li from ListItem li where li.item = :selectedAuthor", ListItem.class);
	...
	public List<ListItem> searchForItemByItem(String categoryName) {
		EntityManager em = emfactory.createEntityManager();
		em.getTransaction().begin();
		TypedQuery<ListItem> typedQuery = em.createQuery("select li from ListItem li where li.item = :selectedCategory", ListItem.class);
