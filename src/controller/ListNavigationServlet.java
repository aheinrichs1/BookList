	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (act == null) {
			...
			try {
				...
				request.setAttribute("month", listToEdit.getDateModified().getMonthValue());
				request.setAttribute("date", listToEdit.getDateModified().getDayOfMonth());
				request.setAttribute("year", listToEdit.getDateModified().getYear());
